...
describe("Acquisition Rest API", () => {
    ...
    describe("Get /health", () => {
        it("should be healthy if and only if correctly configured", (done) => {
            let isProductionReady = (storageInstance instanceof azure_storage_1.AzureStorage || storageInstance instanceof json_storage_1.JsonStorage || storageInstance instanceof aws_storage_1.S3Storage) || (redisManager && redisManager.isEnabled);
            let expectedStatusCode = isProductionReady || isAzureServer ? 200 : 500;
    ...
    describe("Get /updateCheck", () => {
        let malformedURL = "Malformed URL";
        beforeEach((done) => {
            requestParameters = {
    ...
    describe("Metrics Tests", () => {
        ...
        describe("POST /reportStatus/deploy", () => {
            ...
            it("returns 200 and increments the correct counters in Redis when switching deployment keys if SDK version is >=1.5.2-beta", (done) => {
                ...
                let anotherDeployment = utils.makeStorageDeployment();
                storageInstance
