...
exports.S3Storage = exports.MODELS = void 0;
...
function createAccount(sequelize) {
    return sequelize.define("account", {
        createdTime: { type: sequelize_1.DataTypes.FLOAT, allowNull: false, defaultValue: () => new Date().getTime() }, // Set default value
        name: { type: sequelize_1.DataTypes.STRING, allowNull: false },
...
function createDeployment(sequelize) {
    return sequelize.define("deployment", {
        ...
        packageId: {
            type: sequelize_1.DataTypes.UUID, // Use UUID type if 'packages.id' is a UUID
            allowNull: true,
            references: {
...
class S3Storage {
    constructor() {
        this.bucketName = process.env.S3_BUCKETNAME || "codepush-local-bucket";
