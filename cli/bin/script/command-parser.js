...
yargs
    ...
    .command("app", "View and manage your Dota apps", (yargs) => {
    isValidCommandCategory = true;
    yargs
    ...
    .command("debug", "View the Dota debug logs for a running app", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
    ...
    .command("link", "Link an additional authentication provider (e.g. GitHub) to an existing Dota account", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
    ...
    .command("login", "Authenticate with the Dota server in order to begin managing your apps", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
        ...
        default: null,
        demand: false,
        description: "Access key to authenticate against the Dota server with, instead of providing your username and password credentials",
        type: "string",
    })
        .check((argv, aliases) => isValidCommand); // Report unrecognized, non-hyphenated command category.
    addCommonConfiguration(yargs);
    ...
    .command("register", "Register a new Dota account", (yargs) => {
    isValidCommandCategory = true;
    isValidCommand = true;
    yargs
