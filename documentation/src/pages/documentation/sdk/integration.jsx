export default function SDKIntegration() {
  return (
    <div>
      ...
      <h1 className="text-4xl font-bold mb-6">Adding CodePush SDK to your React Native app</h1>
      ...
      <div className="mb-8" id="install">
        <h2 className="text-2xl font-bold mb-4">Install the CodePush client</h2>
      ...
      <div className="mb-8" id="ios-setup">
        ...
        <p className="text-lg">
          The setup for iOS can be followed from the official CodePush documentation <a href="https://github.com/dream-sports-labs/dota/blob/master/docs/setup-ios.md#ios-setup">here</a>.
        </p>
      </div>
      ...
      <div className="mb-8" id="android-setup">
        ...
        <p className="text-lg">
          The setup for Android can be followed from the official CodePush documentation <a href="https://github.com/dream-sports-labs/dota/blob/master/docs/setup-android.md#android-setup">here</a>.
        </p>
      </div>
...
<string>https://dota-server.yourdomain.com/</string>`}
    ...
    <string moduleConfig="true" name="CodePushServerUrl">https://dota-server.yourdomain.com/</string>
      ...
      <div className="mb-8" id="usage">
        ...
        <p className="text-lg mb-4">
          There are many ways to use CodePush in your app. The most common way is to wrap your root
          component with the codePush higher-order component.
        </p>
        <pre className="code-block">
...
MyApp = codePush(MyApp);`}
      ...
      <div className="mb-8" id="additional-plugin-usage">
        ...
        <p className="text-lg mb-4">
          With the CodePush plugin downloaded and linked, and your app asking CodePush where to get
        ...
        <p className="text-lg mb-4">
          The simplest way to do this is to "CodePush-ify" your app's root component. To do so, you
...
export default codePush(MyApp);`}
      ...
      <div className="mb-8" id="manual-check">
        ...
        <p className="text-lg mb-4">
          ...
          interval), you can call CodePush.sync() at any time with your desired SyncOptions, and
          optionally turn off CodePush's automatic checking by specifying a manual checkFrequency:
        </p>
        <pre className="code-block">
