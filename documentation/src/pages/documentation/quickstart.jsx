...
export default function Quickstart() {
  return (
    <div className="content">
      ...
      <div className="mb-8 p-6 bg-white dark-mode:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark-mode:border-gray-700">
      ...
      <div className="mb-8 p-6 bg-white dark-mode:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark-mode:border-gray-700">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 dark-mode:bg-gray-900 p-4 rounded-lg border border-gray-200 dark-mode:border-gray-700">
          ...
          <div className="bg-gray-50 dark-mode:bg-gray-900 p-4 rounded-lg border border-gray-200 dark-mode:border-gray-700">
            ...
            <p className="mt-2 text-sm text-gray-500 dark-mode:text-gray-400">Example: <code className="bg-gray-200 dark-mode:bg-gray-700 px-1 rounded">./launchdota.sh .</code></p>
            
            <div className="alert-note mt-4 p-3 bg-blue-50 dark-mode:bg-blue-900/30 rounded-lg border border-blue-200 dark-mode:border-blue-800 flex">
              <svg
                ...
                className="text-blue-500 dark-mode:text-blue-400 flex-shrink-0 mr-2"
              >
            ...
            <div className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark-mode:from-blue-900/30 dark-mode:to-indigo-900/30 rounded-lg border border-blue-200 dark-mode:border-blue-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white/80 dark-mode:bg-gray-800/80 p-3 rounded-md shadow-sm border border-blue-100 dark-mode:border-blue-900">
              ...
              <div className="mt-4 bg-white/80 dark-mode:bg-gray-800/80 p-3 rounded-md shadow-sm border border-blue-100 dark-mode:border-blue-900">
                ...
                <div className="bg-gray-100 dark-mode:bg-gray-900 p-2 rounded-md font-mono text-sm">
                  <code>dota --version</code><br/>
                  <code>dota whoami</code>
                </div>
              </div>
              
              <div className="mt-4 p-3 bg-white/80 dark-mode:bg-gray-800/80 rounded-md shadow-sm border border-blue-100 dark-mode:border-blue-900">
      ...
      <div className="mb-8 p-6 bg-white dark-mode:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark-mode:border-gray-700">
        ...
        <ol className="list-decimal pl-6 mb-6 space-y-4">
          <li>
            ...
            <div className="bg-gray-100 dark-mode:bg-gray-900 p-3 rounded-lg mt-2">
              <code className="text-sm font-mono">git clone https://github.com/dream-sports-labs/dota</code>
            </div>
          </li>
      ...
      <div className="mb-8 p-6 bg-white dark-mode:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark-mode:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="bg-gray-50 dark-mode:bg-gray-900 p-3 rounded-lg border border-gray-200 dark-mode:border-gray-700">
      ...
      <div className="mb-8 p-6 bg-white dark-mode:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark-mode:border-gray-700">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li className="flex items-center">
            <span className="mr-2">🌐</span> Server running at <code className="bg-gray-100 dark-mode:bg-gray-900 px-2 py-1 rounded ml-1">http://localhost:3010</code>
          </li>
          <li className="flex items-center">
            <span className="mr-2">🕹️</span> CLI logged in (verify with <code className="bg-gray-100 dark-mode:bg-gray-900 px-2 py-1 rounded mx-1">dota --version</code> and <code className="bg-gray-100 dark-mode:bg-gray-900 px-2 py-1 rounded mx-1">dota whoami</code>)
          </li>
          <li className="flex items-center">
            <span className="mr-2">🖥️</span> Web server running at <code className="bg-gray-100 dark-mode:bg-gray-900 px-2 py-1 rounded ml-1">http://localhost:3000</code>
          </li>
        </ul>
      </div>
    </div>
